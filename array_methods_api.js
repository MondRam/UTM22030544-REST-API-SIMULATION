...
function sendReponse(code, body = null) {
  ...
  // GET book: takes one book title OR ISBN and return it if exists.
...
console.log(removeBookByTitleOrISBN("978456806"));
...
function filterBy(property, search) {
    try{
        if (property && search){
            if (property === "Genre"){
...
console.log(getBooksByYear(1997));
